...
for (var i = 1; i <= 28; i++) {
    if(i == 2){
        $('#agenda__1 .day_'+i).append('<div data-plan="'+i+'" style="width: 100%" class="p-0 pt-2 bg-orange both offset-left pb-2"><p class="text-white font-weight-bold m-0">a</p></div>');
    ...
    if(i == 3){
        $('#agenda__1 .day_'+i).append('<div data-plan="1'+i+'" style="width: 100%" class="p-0 pt-2 bg-blue both offset-left pb-2"><p class="text-white font-weight-bold m-0">b</p></div>');
        $('#agenda__2 .day_'+i).append('<div data-plan="2'+i+'" style="width: 100%" class="p-0 pt-2 bg-blue both pb-2"><p class="text-white font-weight-bold m-0">c</p></div>');
    ...
    if(i == 5){
        $('#agenda__1 .day_'+i).append('<div data-plan="1'+i+'" style="width: 200%" class="p-0 pt-2 bg-blue both pb-2"><p class="text-white font-weight-bold m-0">a</p></div>');
        $('#primary .day_'+i).append('<div style="width: 200%" class="p-0 pt-2 both pb-2"><p class="text-white font-weight-bold m-0">1</p></div>');
    }   
    if(i == 10){
        $('#agenda__1 .day_'+i).append('<div data-plan="1'+i+'" style="width: 100%" class="p-0 pt-2 bg-blue both pb-2"><p class="text-white font-weight-bold m-0">k</p></div>');
        $('#agenda__2 .day_'+i).append('<div data-plan="2'+i+'" style="width: 100%" class="p-0 pt-2 bg-blue offset-left both pb-2"><p class="text-white font-weight-bold m-0">d</p></div>');
    ...
    if(i == 11){
        $('#agenda__1 .day_'+i).append('<div data-plan="1'+i+'" style="width: 350%" class="p-0 pt-2 bg-orange both pb-2"><p class="text-white font-weight-bold m-0">dmo</p></div>');
        $('#agenda__2 .day_'+i).append('<div data-plan="2'+i+'" style="width: 150%" class="p-0 pt-2 bg-blue offset-left both pb-2"><p class="text-white font-weight-bold m-0">agrnlgkr..</p></div>');
        $('#agenda__3 .day_'+i).append('<div data-plan="3'+i+'" style="width: 1050%" class="p-0 pt-2 bg-purple both pb-2"><p class="text-white font-weight-bold m-0">a</p></div>');
        $('#agenda__4 .day_'+i).append('<div data-plan="4'+i+'" style="width: 100%" class="p-0 pt-2 bg-blue offset-left both pb-2"><p class="text-white font-weight-bold m-0">d</p></div>');
    ...
    if(i == 14){
        $('#agenda__1 .day_'+i).append('<div data-plan="1'+i+'" style="width: 100%" class="p-0 pt-2 bg-blue offset-left both pb-2"><p class="text-white font-weight-bold m-0">a</p></div>');
        $('#agenda__2 .day_'+i).append('<div data-plan="2'+i+'" style="width: 900%" class="p-0 pt-2 bg-light-blue  both pb-2"><p class="text-white font-weight-bold m-0">e</p></div>');
        $('#agenda__4 .day_'+i).append('<div data-plan="4'+i+'" style="width: 1000%" class="p-0 pt-2 bg-yellow offset-left both pb-2"><p class="text-white font-weight-bold m-0">d</p></div>');
        $('#primary .day_'+i).append('<div style="width: 50%" class="p-0 pt-2 center pb-2"><p class="text-white font-weight-bold m-0">3</p></div>');
        $('#primary .day_'+i).append('<div style="width: 50%" class="p-0 pt-2 center pb-2"><p class="text-white font-weight-bold m-0">4</p></div>');        
    }
    if(i == 15){
        $('#agenda__5 .day_'+i).append('<div data-plan="5'+i+'" style="width: 100%" class="p-0 pt-2 bg-blue both pb-2"><p class="text-white font-weight-bold m-0">d</p></div>');
    ...
    if(i == 24){
        $('#agenda__1 .day_'+i).append('<div data-plan="1'+i+'" style="width: 50%" class="p-0 pt-2 bg-blue offset-left both pb-2"><p class="text-white font-weight-bold m-0">a</p></div>');
    ...
    if(i == 25){
        $('#agenda__1 .day_'+i).append('<div data-plan="1'+i+'" style="width: 50%" class="p-0 pt-2 bg-blue both pb-2"><p class="text-white font-weight-bold m-0">...</p></div>');
